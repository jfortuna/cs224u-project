...
def write_to_file(filename_output, all_scores):
	...
	for pair, score in all_scores.iteritems():
		score_output = str(score[0]) + " " + str(numpy.array(score[1]))
...
# print speaker_pairs
# all_scores = coordination_features(speaker_pairs)
...
write_to_file('testoutput', test_scores)
# sklearn_test.svm_train('supremecourt', allscores)
######Sanity Check#########
